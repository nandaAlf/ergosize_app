...
from .views import Perceptil, PersonViewSet, MeasurementViewSet, StudyDataView, StudyDimensionViewSet, StudyViewSet, DimensionViewSet, export_excel_percentiles, export_pdf_percentiles, generar_pdf_ficha, preview_excel_percentiles
...
urlpatterns = [
    ...
    path('report2/', generar_pdf_ficha, name='b'),
]
